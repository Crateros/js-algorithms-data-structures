...
// She can jump on any cumulus cloud (0) having a number that is equal to the number of the current cloud plus 1 or 2.
// She must avoid the thunderheads (1). Determine the minimum number of jumps it will take Emma to jump from her
...
// Sampke output: 4 ([1, 3, 4, 6])

// Sample input: c=[0, 0, 0, 0, 1, 0]
// Sampke output: 3 ([1, 3, 5])
